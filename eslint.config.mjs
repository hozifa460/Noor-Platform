...
const CROSS_FEATURE_RESTRICTIONS = [
  "@/features/*/**",
  "../../adhkar",
  "../../adhkar/**",
  "../../../adhkar",
...
const DOMAIN_PURITY_RESTRICTIONS = [
  "../ui",
  "../ui/**",
  "../../ui",
  "../../ui/**",
...
const RETIRED_LEGACY_PATTERN = {
  ...
  message:
    "Architecture violation: Legacy compatibility paths for books, hadith, and fatwa have been retired. Use canonical feature imports: '@/features/books', '@/features/hadith', or '@/features/fatwa'.",
};
...
const eslintConfig = [
  ...
  // Architectural Boundaries: Domain layers must be pure and never import from UI, model, or infrastructure, AND must inherit cross-feature restrictions
  {
        ...
        "error",
        {
          patterns: [
            RETIRED_LEGACY_PATTERN,
            {
              group: CROSS_FEATURE_RESTRICTIONS,
              message:
                "Architecture violation: Domain layer must only access other features through their approved root public facade, not internal private subpaths or cross-feature relative paths.",
            },
            {
              group: DOMAIN_PURITY_RESTRICTIONS,
              message:
