...
export function middleware() {
  ...
  const csp = [
    ...
    `media-src 'self' blob: https://everyayah.com https://*.everyayah.com https://mp3quran.net https://*.mp3quran.net https://server6.mp3quran.net https://server7.mp3quran.net https://server8.mp3quran.net https://archive.org https://*.archive.org https://huggingface.co https://*.huggingface.co https://cdn-lfs.hf.co https://*.hf.co https://*.aws.cdn.hf.co https://us.aws.cdn.hf.co https://cdn.islamic.network https://download.quranicaudio.com https://*.quranicaudio.com https://*.radiojar.com https://stream.radiojar.com http://*.radiojar.com http://stream.radiojar.com https://*.zeno.fm https://stream.zeno.fm https://*.surfernetwork.com https://*.itworkscdn.net https://l3.itworkscdn.net https://*.mp3islam.com https://radio.mp3islam.com https://*.radio.co https://streams.radio.co https://*.simplestreaming.co.za https://*.fastcast4u.com https://qurango.net https://*.qurango.net https://raw.githubusercontent.com`,
    `frame-src 'self' https://www.youtube.com https://www.youtube-nocookie.com`,
    `connect-src 'self' blob: data: https://everyayah.com https://*.everyayah.com https://huggingface.co https://*.huggingface.co https://cdn-lfs.hf.co https://*.hf.co https://*.aws.cdn.hf.co https://us.aws.cdn.hf.co https://raw.githubusercontent.com https://api.alquran.cloud https://api.qurancdn.com https://mp3quran.net https://*.mp3quran.net https://archive.org https://*.archive.org https://gitlab.com https://*.ytimg.com https://www.youtube.com https://*.upstash.io`,
