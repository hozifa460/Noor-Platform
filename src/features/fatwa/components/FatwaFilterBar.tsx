...
import { FATWA_CATEGORIES, SCHOLARS_LIST } from '../engines/index-data';
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4 bg-card/70 p-4 sm:p-5 rounded-3xl border border-border/80 backdrop-blur-md shadow-xs">
        ...
        <div className="flex items-center gap-2 w-full md:w-auto justify-end">
          ...
          >
            ...
            {SCHOLARS_LIST.filter((s) => s.id !== 'all').map((scholar) => (
            ...
            <button
              ...
              className={cn(
                ...
                isSelected
                  ...
                  : 'bg-card/70 border-border/80 text-muted-foreground hover:text-foreground hover:bg-muted/50'
              )}
            >
              <span>{cat.emoji}</span>
              <span>{cat.name}</span>
