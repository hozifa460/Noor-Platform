...
import { shardUrl } from '@/lib/shared';
import type { AnswerRecord, FatwaFullContent } from '../domain';
...
/** Pre-warms shard fetches for ids about to be shown. */
...
export const preloadAnswerShards = prefetchFatwaContent;

/** True when we have an answer entry for this id. */
