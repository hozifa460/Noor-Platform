...
import { searchHadithsInBook, getHadithGrade, isMuttafaqunAlayh } from '../infrastructure';
import { useHadithStore } from '../model';
              ...
              <div className="py-20 text-center space-y-3 bg-card rounded-3xl border border-border p-6">
                ...
                <p className="text-xs text-muted-foreground max-w-md mx-auto">
                  {globalSearchError === 'timeout'
                    ? 'انتهت مهلة تحميل الفهرس (أكثر من 90 ثانية لكل مصدر) — تحقق من الاتصال ثم أعد المحاولة.'
                    : globalSearchError === 'invalid-payload'
                    ? 'مصدر الفهرس أعاد بيانات غير صالحة — أعد المحاولة، وإن تكرّر الخطأ فالمصدر يحتاج مراجعة.'
