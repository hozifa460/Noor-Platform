...
async function runTests() {
  ...
  const { getHadithGrade, loadSunanGrades } = await import('../src/features/hadith/index.ts');
  ...
  } = await import('../src/features/hadith/index.ts');
  ...
  const { loadHadithBook, searchAcrossAllBooks } = await import('../src/features/hadith/index.ts');
