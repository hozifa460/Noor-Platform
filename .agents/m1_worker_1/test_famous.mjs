import { normalizeArabicText, extractHadithMatn } from './test_regex.mjs';
...
const famousHadithQueries = [
  ...
  { query: 'كلمتان حبيبتان الي الرحمن', name: 'Last Hadith of Bukhari: Two words beloved to Ar-Rahman' },
];
